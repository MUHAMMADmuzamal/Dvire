...
const PAGES_NAMES = {
    ...
    ABOUT_PAGE: "Apie",
    CARD_PAGE: "kortelę",
    DICTIONARY_PAGE: "Žodynas",
    LAWS_PAGE: "Įstatymai",
    NEWS_PAGE: "žinios",
    NEWS_DETAIL_PAGE: "NaujienosDetaliau",
    BLOG_PAGE: "Dienoraščiai",
    LANG_PAGE : "LT | EN",
    LOGIN_PAGE : "Prisijungti",
    LOGOUT_PAGE : "Atsijungti",
    SIGNUP_PAGE : "Registruotis",
    PROFILE_PAGE : "Profilis",
    FORGET_PASSWORD_PAGE : "Pamiršti slaptažodį",
    CONTACTS_PAGE : "kontaktas",
    PROPS_PAGE : "Rekvizitas",
    GAS_STATION_NETWORK_MAP_PAGE : "Degalinių tinklo žemėlapis",
    GAS_STATION_NETWORK_MAP_WITHOUT_SPACE_PAGE : "GasStationNetworkMap",
    REQUEST_FORM_PAGE : "Prašymo forma",
    REQUEST_FORM_WITHOUT_SPACE_PAGE : "RequestForm",
    SELF_SERVICE_PAGE : "Savitarna",
    PAYMENT_CARD_PAGE : "Degalų mokėjimo kortelės pirkimas",
    PAYMENT_CARD_WITHOUT_SPACE_PAGE : "Purchase_of_a_fuel_payment_card",
    CONSULTATION_ORDER_PAGE : "Konsultacijos užsakymas",
    CONSULTATION_ORDER_WITHOUT_SPACE_PAGE : "Consultationorder",
    CONSULTATION_DESCRIPTION_PAGE : "Konsultacijos aprašymas",
    CONSULTATION_DESCRIPTION_WITHOUT_SPACE_PAGE : "ConsultationDescription",
    LEGAL_ENVIRONMENT_PAGE : "Teisinė aplinka",
    EU_INVESTMENTS_PAGE : "ES investicijos",
    EU_INVESTMENTS_WITHOUT_SPACE_PAGE : "EUInvestments",
    LEGAL_ENVIRONMENT_WITHOUT_SPACE_PAGE : "Teisinė aplinka",
    // LANDING_PAGE: "Home",
    // ABOUT_PAGE: "About",
    // CARD_PAGE: "Card",
...
const APP_SETTINGS = {
  API_PATH: {
    ...
    LANGUAGES:{
      ...
      allWordslit: baseUrl + '/api/allwordslit',
    }
  },
};
